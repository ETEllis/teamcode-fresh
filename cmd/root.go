...
import (
	...
	"github.com/opencode-ai/teamcode/internal/app"
	"github.com/opencode-ai/teamcode/internal/config"
	"github.com/opencode-ai/teamcode/internal/db"
	"github.com/opencode-ai/teamcode/internal/format"
	"github.com/opencode-ai/teamcode/internal/llm/agent"
	"github.com/opencode-ai/teamcode/internal/logging"
	"github.com/opencode-ai/teamcode/internal/pubsub"
	"github.com/opencode-ai/teamcode/internal/tui"
...
to assist developers in writing, debugging, and understanding code directly from the terminal.`,
  ...
  teamcode -d -c /path/to/project

  # Print version
  teamcode -v

  # Run a single non-interactive prompt
  teamcode -p "Explain the use of context in Go"

  # Run a single non-interactive prompt with JSON output format
  teamcode -p "Explain the use of context in Go" -f json
  `,
